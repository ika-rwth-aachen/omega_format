...
class Sensor(BaseModel):
    ...
    angle_resolution: confloat(ge=0) = 0.
    ...
    def from_hdf5(cls, group: Group, validate: bool = True):
        ...
        self = func(
            ...
            angle_resolution=group.attrs['angleResolution'],
            horizontal_resolution=group.attrs['horizontalResolution'],
            ...
            horizontal_accuracy=group.attrs['horizontalAccuracy'],
            velocity_accuracy=group.attrs['velocityAccuracy'],
            angle_precision=group.attrs['anglePrecision'],
            horizontal_precision=group.attrs['horizontalPrecision'],
    ...
    def to_hdf5(self, group: Group):
        ...
        group.attrs.create('angleResolution', data=self.angle_resolution)
        group.attrs.create('horizontalResolution', data=self.horizontal_resolution)
        ...
        group.attrs.create('horizontalAccuracy', data=self.horizontal_accuracy)
        ...
        group.attrs.create('horizontalPrecision', data=self.horizontal_precision)
