...
class Precipitation(InputClassBase):
    ...
    amount_hourly: np.ndarray = Field(default=np.array([], dtype=np.float64))
    amount_minute: np.ndarray = Field(default=np.array([], dtype=np.float64))
    new_snow_depth: np.ndarray = Field(default=np.array([], dtype=np.float64))
    snow_depth: np.ndarray = Field(default=np.array([], dtype=np.float64))
